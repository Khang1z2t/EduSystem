...
public class QLKH extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tblCourse.setBackground(new java.awt.Color(217, 237, 191));
        tblCourse.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(90, 139, 145), 2));
        tblCourse.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        tblCourse.setForeground(new java.awt.Color(123, 188, 196));
        ...
        tblCourse.setToolTipText("");
        tblCourse.setGridColor(new java.awt.Color(90, 139, 145));
...
//            System.exit(0);
    ...
    private void deleteKH() {
        ...
        Integer id = Integer.valueOf(cboSpecialized.getToolTipText());
        try {
            khDAO.delete(id);
            this.fillTable();
            this.clearForm();
