 ...
 */
//Learner
public class QLNH extends javax.swing.JDialog {
    LearnerDAO dao = new LearnerDAO();
    int index = -1;

    /**
     * Creates new form QLNH_JDialog
     */
    public QLNH(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        findNH();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                QLNH dialog = new QLNH(new javax.swing.JFrame(), true);
